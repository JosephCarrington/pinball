...
namespace BansheeGz.BGSpline.Components
{
    ...
    [
        CcDescriptor(
            ...
            Image = "Assets/BansheeGz/BGCollider/Icons/BGCcCollider2DBox123.png")
    ]
    ...
    public class BGCcCollider2DBox : BGCcColliderAbstract<BoxCollider2D>
    {
        ...
        [SerializeField] [Tooltip("Height offset for colliders")] private float heightOffset;

        [SerializeField] [Tooltip("Set BoxCollider2D usedByEffector flag")] private bool usedByEffector;

        [SerializeField] [Tooltip("Material for colliders")] private PhysicsMaterial2D material;

        [SerializeField] [Tooltip("Extends for colliders length")] private float lengthExtends;

        [SerializeField] [Tooltip("Effector for colliders")] private Effector2D effector;
